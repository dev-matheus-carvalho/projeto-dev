...
export class FiltrarLotesInput {
  ...
  constructor(pData: EntrypointData) {
    const dataInicialValidador = ValidadorDados.iniciar(pData.body?.dataInicial, 'body.dataInicial').obrigatorio().string();
    const dataFinalValidador = ValidadorDados.iniciar(pData.body?.dataFinal, 'body.dataFinal').obrigatorio().string();
