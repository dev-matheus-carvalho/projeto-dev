...
import { CheckboxComponent, ToasterService } from '@decisaosistemas/angular-ds';
...
@Component({
  selector: 'app-card-titulos',
  templateUrl: './card-titulos.component.html',
  styleUrl: './card-titulos.component.scss'
})
export class CardTitulosComponent {
